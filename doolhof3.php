...
<html>
        ...
        function collision() {
            ...
            //als het maximale getal te hoog is werkt de finish niet.
                ...
                if (player.top > muur_bottom || player.right < muur_left || player.bottom < muur_top || player.left > muur_right) {
                    ...
                    //hieronder bericht zodat een glitch niet meer werkt en het zo gewoon leuk is.
    ...
    <body onkeydown="get_key(event)" onload="reset_player();">
        <main>   
            ...
            <div id="muur2" style="position: absolute; top: 32%; left: 0%; height: 2%; width: 13%; background-color: white;"></div>
            ...
            <div id="muur5" style="position: absolute; top: 46%; left: 0%; height: 66%; width: 2%; background-color: white;"></div>
            ...
            <div id="muur8" style="position: absolute; top: 8%; left: 98%; height: 90%; width: 2%; background-color: white;"></div>

            <div id="muur9" style="position: absolute; top: 46%; left: 2%; height: 1%; width: 5%; background-color: white;"></div>
            ...
            <div id="finish" style="position: absolute; top: 34%; left: 0%; height: 12%; width: 6%; background-color: green;"></div>
